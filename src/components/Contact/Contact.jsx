            ...
            <div className="w-full">
                <div className="max-w-[570px] my-4 lg:mb-0">
                  ...
                  <p className="text-base text-body-color leading-relaxed mb-9">
                      If you want to ask more , you can contact me from phone number or email adddress. 
                      We will reply as fast as to you.
                  </p>
                  </Bounce>
                  <Bounce top>
                    <div className="flex mb-8 max-w-[370px] w-full">
                        ...
                        <div className="w-full">
                          ...
                          <p className="text-base text-body-color">
                              No.49, Pagoda Road, Thingungyun, Yangon
                          </p>
                        </div>
                    </div>
                  </Bounce>
                  <Bounce left>
                    <div className="flex mb-8 max-w-[370px] w-full">
                        ...
                        <div className="w-full">
                          ...
                          <p className="text-base text-body-color">(+95)979 314 8428</p>
                        </div>
                    </div>
                  </Bounce>
                  <Bounce bottom>
