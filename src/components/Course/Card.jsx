                        ...
                        <div className="h-full shadow-lg hover:shadow-xl transition duration-300 rounded-lg overflow-hidden">
                            ...
                            <p className="mb-3">
                                {
                                    course.description !== null ? <>
                                        ...
                                        <NavLink to={`/courses/${course.id}`} className='ml-2 text-primary'>See More....</NavLink>
                                    </>
                                     :
                                    <>
                            ...
                            </p>
                            {
                                ...
                                <div className="flex items-center justify-between flex-wrap gap-y-3">
                                    <NavLink to={`/courses/${course.id}`} className="text-primary inline-flex items-center md:mb-2 lg:mb-0">Outlines
